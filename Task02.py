...
# set bg images
background_image = tk.PhotoImage(file="im.png")
...
buttons = []
for i in range(10):
    button = tk.Button(window, text=str(i), padx=20, pady=10,bg="darkslategrey", command=lambda i=i: button_click(i))
...
add_button = tk.Button(window, text="+", padx=20, pady=10,bg="grey", command=lambda: button_click("+"))
subtract_button = tk.Button(window, text="-", padx=20, pady=10,bg="grey", command=lambda: button_click("-"))
multiply_button = tk.Button(window, text="*", padx=20, pady=10,bg="grey", command=lambda: button_click("*"))
divide_button = tk.Button(window, text="/", padx=20, pady=10,bg="grey", command=lambda: button_click("/"))
sqrt_button = tk.Button(window, text="√", padx=20, pady=10,bg="grey", command=button_sqrt)
equal_button = tk.Button(window, text="=", padx=20, pady=10,bg="grey", command=button_equal)
clear_button = tk.Button(window, text="C", padx=20, pady=10,bg="grey", command=button_clear)
